...
const API_BASE_URL = 'http://localhost:8080/api/estimates/address-commission';
 ...
 */
const useGetAddressCommission = (departurePort, arrivalPort, percentage) => {
...
export default useGetAddressCommission;
